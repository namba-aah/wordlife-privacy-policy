...
A creative automation workflow built with n8n to publish poetic content to Pinterest using secure OAuth2 integration.
## Privacy & Data Use

This application integrates with the Pinterest API to help users publish and manage their own content.

- **Data Access**: The app only requests the minimum scopes required (e.g., `pins:write`, `boards:read`) to allow publishing pins and organizing boards.  
